// Shared session summary card used in both observation and visualization session lists.
  ...
  return (
    <article className="observation-session-card">
      <div className="observation-session-card-main">
        ...
        {supplemental ? <div className="observation-session-card-supplemental">{supplemental}</div> : null}
      </div>
