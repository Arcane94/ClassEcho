    ...
    return (
        <div className="w-full h-screen flex items-center justify-center bg-[var(--accent-color)]">
            <div className="relative w-4/5 max-w-lg py-12 px-5 lg:px-12 bg-white shadow-lg">
                ...
                <div className="flex items-center justify-center border border-[var(--grey-accent-medium)] shadow-lg rounded-lg py-2 px-2 gap-4" onClick={() => navigate("/create-new")}>
                    {/* Icon Div */}
                ...
                <div className="flex items-center mt-6 justify-center border border-[var(--grey-accent-medium)] shadow-lg rounded-lg py-2 px-2 gap-4" onClick={() => navigate("/join-existing")}>
                    {/* Icon Div */}
