...
import { PlusCircle, Layers, ArrowLeft, Eye, PenSquare } from "lucide-react";
        ...
        <div className="w-full h-screen flex items-center justify-center bg-[var(--accent-color)]">
            <div className="relative w-4/5 max-w-lg py-12 px-5 lg:px-12 bg-white shadow-lg">
                ...
                <div className="flex items-center mt-6 justify-center border border-[var(--grey-accent-medium)] shadow-lg rounded-lg py-2 px-2 gap-4 cursor-pointer" onClick={() => navigate("/view-sessions")}>
                    ...
                    {/* Text div */}
                    <div>
                        <p className="font-semibold text-md mb-1">View Previous Sessions</p>
                    ...
                    {/* Text div */}
                    <div>
                        <p className="font-semibold text-md mb-1">Manage Your Sessions</p>
                        <p className="text-[var(--grey-accent-medium)] text-xs">View and manage all of the sessions that you have created.</p>
                    </div>
                </div>
            </div>
        </div>
