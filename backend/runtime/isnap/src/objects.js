...
SpriteMorph.prototype.blockTemplates = function (
    ...
    function block(selector, isGhosted) {
        ...
        // This if block was added to temporarily get rid of the annoying null reference error, investigate further
        if (!newBlock) {
            console.log("Block Selector returned a null block.");
            return null;
        }
