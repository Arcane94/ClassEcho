...
try {
    ...
    foreach ($logs as $log) {
        ...
        $timestamp = date("Y-m-d H:i:s", (int) ($log['time'] / 1000));
        ...
        $assignmentID = isset($log['assignmentID']) && $log['assignmentID'] !== null ? $mysqli->escape_string($log['assignmentID']) : 'defaultID';
